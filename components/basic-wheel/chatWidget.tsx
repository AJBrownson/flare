...
export default function ChatWidget() {
  ...
  return (
    <>
      {/* <div className="lg:mt-10 w-[320px] max-h-[34rem] max-w-full lg:max-w-[20rem]"> */}
      <div className="font-space w-[340px] xl:max-w-[309px] bg-[#191815] rounded-2xl mt-10 pb-6 text-[#FFFFE3]">
