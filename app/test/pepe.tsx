        ...
        <div ref={modalRef} className="relative xl:px-16">
          ...
          <div className="font-space w-[330px] xl:max-w-[340px] h-[551px] bg-[#191815] rounded-2xl mt-10 pb-8 text-[#FFFFE3]">
            ...
            {connected && publicKey ? (
              ...
              <div className="text-center text-white mt-4">Please connect your wallet</div>
            )}
          </div>
        </div>
      </div>

      <WalletConnectionModal isOpen={isWalletConnectModalOpen} onClose={() => setIsWalletConnectModalOpen(false)} />
    </>
  );
}
